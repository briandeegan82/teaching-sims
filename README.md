...
| # | Demo | Tutorial | Launch |
| --- | --- | --- | --- |
| 9 | MEMS comb-drive sensing | [14](tutorials/14-mems-accel.md) | `teaching-sims demo mems-accel` |
| 10 | Accelerometer / tilt | [08](tutorials/08-accelerometer.md) | `teaching-sims demo accelerometer` |
| 11 | Gyroscope / integration | [09](tutorials/09-gyroscope.md) | `teaching-sims demo gyroscope` |
| 12 | Attitude (Euler/DCM/quat) | [10](tutorials/10-attitude.md) | `teaching-sims demo attitude` |
| 13 | Complementary filter | [11](tutorials/11-complementary.md) | `teaching-sims demo complementary` |
| 14 | Magnetometer / heading | [12](tutorials/12-magnetometer.md) | `teaching-sims demo magnetometer` |
| 15 | Strapdown INS | [13](tutorials/13-ins.md) | `teaching-sims demo ins` |
